  ...
  return (
    ...
    >
      ...
      <motion.p
        ...
        style={{ willChange: 'transform, opacity, filter' }}
      >
        Discover our comprehensive suite of industry solutions — from cutting-edge development to strategic consulting. Each service is crafted to empower your business with innovative technology and expert guidance.
      </motion.p>
